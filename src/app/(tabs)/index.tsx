...
const ChatScreen = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      ...
      {/* Search Bar */}
      <View className="flex-row items-center bg-surface mx-5 mb-3 px-3.5 py-3 rounded-[14] gap-2.5 border border-border">
      ...
      <ChannelList
        ...
        // EmptyStateIndicator={() => (
        //   <Text className="flex1 text-white">Hey start chatting</Text>
        // )}
      />
    </SafeAreaView>
  );
